...
class HiveMQTT3Client implements MQTTClient {
    private static final Logger logger = Logger.getLogger(HiveMQTT3Client.class.getCanonicalName());
    private final ConnectionParameters parameters;
    private final Mqtt3BlockingClient client;

    HiveMQTT3Client(ConnectionParameters parameters) throws Exception {
    ...
    public MQTTConnection connect() throws Exception {
        ...
        try {
            ...
            return new HiveMQTT3Connection(client, parameters.getClientId(), connAck);
