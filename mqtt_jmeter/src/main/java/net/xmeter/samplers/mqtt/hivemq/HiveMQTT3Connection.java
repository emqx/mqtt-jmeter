...
class HiveMQTT3Connection implements MQTTConnection {
    private static final Logger logger = Logger.getLogger(HiveMQTT3Connection.class.getCanonicalName());
    ...
    HiveMQTT3Connection(Mqtt3BlockingClient client, String clientId, Mqtt3ConnAck connAck) {
        this.client = client;
